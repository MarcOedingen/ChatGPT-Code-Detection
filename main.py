...
def main():
    ...
    parser.add_argument(
        ...
        choices=["Formatted", "Unformatted", "Formatted_Large", "Unformatted_Large"],
        default="Unformatted",
    )
    parser.add_argument(
        "--split",
    ...
    parser.add_argument(
        ...
        choices=["DNN", "GMM", "features", "RF", "LR", "GB", "DT", "XGB", "OPCT"],
        default="DT",
    )
    parser.add_argument(
        "--seed",
    ...
    if args.algorithm == "features":
        ...
        run(dataset=args.dataset, split=args.split, seed=args.seed)
